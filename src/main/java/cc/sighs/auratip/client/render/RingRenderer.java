...
public class RingRenderer {
    ...
    public static void drawRing(GuiGraphics gg,
        ...
        buf.addVertex(mat, x1, y1, 0).setUv(0.0f, 0.0f);
        buf.addVertex(mat, x1, y2, 0).setUv(0.0f, 1.0f);
        buf.addVertex(mat, x2, y2, 0).setUv(1.0f, 1.0f);
        buf.addVertex(mat, x2, y1, 0).setUv(1.0f, 0.0f);
