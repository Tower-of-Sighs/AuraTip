...
public class SlideInLeftTransitionAnimation extends BaseSlideTransitionAnimation {
    ...
    public static TransitionAnimation create(Map<String, Dynamic<?>> params) {
        return BaseSlideTransitionAnimation.create(params, SlideInLeftTransitionAnimation::new);
    }
