...
public final class DevJavaApiSamples {
    ...
    private static void registerRuntimeTips() {
        TipData a = new TipBuilder(JAVA_TIP_SHOWTIP)
                ...
                .visual(v -> v
                        .animationStyle(AuraTip.id("slide_in_left"))
                        .hoverAnimationStyle(AuraTip.id("hover_float"))
                        .size(190, 60)
        ...
        TipData b = new TipBuilder(JAVA_TIP_FIRST_JOIN)
                ...
                .visual(v -> v
                        .animationStyle(AuraTip.id("fade_and_slide"))
                        .hoverAnimationStyle(AuraTip.id("none"))
                        .size(180, 48)
        ...
        TipData c = new TipBuilder(JAVA_TIP_BY_ID)
                .triggerRepeatable(AuraTip.id("unused_trigger"), 0)
                .visual(v -> v
                        .animationStyle(AuraTip.id("slide_in_right"))
                        .hoverAnimationStyle(AuraTip.id("hover_shake"))
                        .size(200, 55)
