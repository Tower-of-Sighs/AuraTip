...
public final class EditorCodecSchemas {
    ...
    private static JsonObject itemIconType() {
        return obj(
                ...
                f("components", dynamicMap(), true, new JsonObject(), "radial.slot.icon.item.components", "radial.slot.icon.item.components.desc")
        );
    }
    ...
    private static JsonObject itemIconDefault() {
        ...
        o.addProperty("id", "minecraft:chest");
        o.addProperty("count", 1);
        o.add("components", new JsonObject());
        return o;
    }
