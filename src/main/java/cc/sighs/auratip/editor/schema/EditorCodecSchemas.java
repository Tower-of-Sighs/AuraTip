...
public final class EditorCodecSchemas {
    ...
    private static JsonObject radialIcon() {
        ...
        // Variant 2: item icon (template + optional scale)
    ...
    private static JsonObject itemIconType() {
        return obj(
                ...
                f("template", itemStackFields(), false, null, "radial.slot.icon.item.template", "radial.slot.icon.item.template.desc"),
    ...
    private static JsonObject itemStackFields() {
        return obj(
                ...
                f("components", dynamicMap(), false, new JsonObject(), "radial.slot.icon.item.template.components", "radial.slot.icon.item.template.components.desc")
        );
    }
